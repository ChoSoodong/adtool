...
#import "SDAdPageView.h"

@interface SDAdPageView()
...
//    [PPNetworkHelper POST:NSStringFormat(@"%@%@",kApiPrefix,@"/api/cast/home/start") parameters:@{@"versionId":@100} success:^(id responseObject) {
